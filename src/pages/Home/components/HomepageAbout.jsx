...
const HomepageAbout = () => {
  return (
    <div className="m-auto flex items-center justify-center flex-col w-2/3 pt-9 pb-12 lg:flex-row">
      <h1 className="text-3xl xl:text-4xl p-9 align-middle">Who We Are</h1>
