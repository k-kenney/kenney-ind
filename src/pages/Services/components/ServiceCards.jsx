...
const ServiceCards = () => {
  return (
    <div className="flex flex-col md:flex-row pb-12 m-auto justify-center w-full">
      <div className="md:m-5">
        <div className="w-full m-auto mb-10">
          <div className="services-card1 services-card homepage-card-text">
        ...
        <div className="w-full m-auto mb-10">
          <div className="services-card2 services-card homepage-card-text">
      ...
      <div className="md:m-5">
        <div className="w-full m-auto mb-10">
          <div className="services-card services-card3 homepage-card-text">
        ...
        <div className="w-full m-auto mb-10">
          <div className="services-card homepage-card-text">
